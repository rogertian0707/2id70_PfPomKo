...
#
# SET PRIMARY KEY (NO LONGER NEEDED)
#psql -U postgres -d uni -c "ALTER TABLE Degrees ADD PRIMARY KEY (DegreeId) ;"
#psql -U postgres -d uni -c "ALTER TABLE Students ADD PRIMARY KEY (StudentId) ;"
#psql -U postgres -d uni -c "ALTER TABLE Teachers ADD PRIMARY KEY (TeacherId) ;"
#psql -U postgres -d uni -c "ALTER TABLE Courses ADD PRIMARY KEY (CourseId) ;"
#psql -U postgres -d uni -c "ALTER TABLE CourseOffers ADD PRIMARY KEY (CourseOfferId) ;"
#psql -U postgres -d uni -c "ALTER TABLE StudentRegistrationsToDegrees ADD PRIMARY KEY (StudentRegistrationId) ;"
#
